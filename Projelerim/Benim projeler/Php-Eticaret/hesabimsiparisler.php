...
<table width="1065" align="center" border="0" cellpadding="0" cellspacing="0">
	...
	<tr>
		<td width="203" style="border: 1px solid black; text-align: center; padding: 10px 0; font-weight: bold; background: yellow;"><a href="index.php?SK=50" style="text-decoration: none; color: black;">Üyelik Bilgileri</a></td>
		<td width="10">&nbsp;</td>
		<td width="203" style="border: 1px solid black; text-align: center; padding: 10px 0; font-weight: bold; background: cyan;"><a href="index.php?SK=58" style="text-decoration: none; color: black;">Adresler</a></td>
		<td width="10">&nbsp;</td>
		<td width="203" style="border: 1px solid black; text-align: center; padding: 10px 0; font-weight: bold; background: red;"><a href="index.php?SK=59" style="text-decoration: none; color: black;">Favoriler</a></td>
		<td width="10">&nbsp;</td>
		<td width="203" style="border: 1px solid black; text-align: center; padding: 10px 0; font-weight: bold; background: bisque;"><a href="index.php?SK=60" style="text-decoration: none; color: black;">Yorumlar</a></td>
		<td width="10">&nbsp;</td>
		<td width="203" style="border: 1px solid black; text-align: center; padding: 10px 0; font-weight: bold; background: orange;"><a href="index.php?SK=61" style="text-decoration: none; color: black;">Siparişler</a></td>
	</tr>
		</table></td>
	</tr>
	<tr>
	...
	<tr>
		<td width="1065" valign="top">
			<table width="1065" align="center" border="0" cellpadding="0" cellspacing="0">
				<tr height="40">
					<td colspan="8" style="background:orange"><h2 style="color:black">Hesabım > Siparişler</h2></td>
				</tr>
				<tr height="30">
					<td colspan="8" valign="top" style="border-bottom: 1px dashed #CCCCCC;"><b>Tüm Siparişlerinizi Bu Alandan Görüntüleyebilirsiniz.</b></td>
				</tr>
				<tr height="50">
					<td width="125" style="background: orange; color: black;" align="left">&nbsp;Sipariş Numarası</td>
					<td width="75" style="background: orange; color: black;" align="left">Resim</td>
					<td width="50" style="background: orange; color: black;" align="left">Yorum</td>
					<td width="415" style="background: orange; color: black;" align="left">Adı</td>
					<td width="100" style="background: orange; color: black;" align="left">Fiyatı</td>
					<td width="50" style="background: orange; color: black;" align="left">Adet</td>
					<td width="100" style="background: orange; color: black;" align="left">Toplam Fiyat</td>
					<td width="150" style="background: orange; color: black;" align="left">Kargo Durumu / Takip</td>
				</tr>
				<?php
					...
					foreach($SiparisNumaralariKayitlari as $SiparisNumaralariSatirlar){
						...
						foreach($SiparisSorgusuKayitlari as $SiparisSatirlar){
							$UrunTuru		=	DonusumleriGeriDondur($SiparisSatirlar["UrunTuru"]);
								if($UrunTuru == "Erkek T-Shirt"){
									$ResimKlasoruAdi	=	"Erkek";
								}elseif($UrunTuru == "Kadın T-Shirt"){
