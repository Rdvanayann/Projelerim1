...
<table width="1065" align="center" border="0" cellpadding="0" cellspacing="0">
	...
	<tr>
		<td width="1065" valign="top">
			<table width="1065" align="center" border="0" cellpadding="0" cellspacing="0">
				<tr height="40">
					<td colspan="4" style="background:red"><h2 style="color:black">Hesabım > Favoriler</h2></td>
				</tr>
				<tr height="30">
					<td colspan="4" valign="top" style="border-bottom: 1px dashed #CCCCCC;"><b>Favorilerinize Eklediğiniz Tüm Ürünleri Bu Alandan Görüntüleyebilirsiniz.</b></td>
				</tr>
				<tr height="50">
					<td width="75" style="background: red; color: black;" align="left">&nbsp;Resim</td>
					<td width="25" style="background: red; color: black;" align="left">Sil</td>
					<td width="865" style="background: red; color: black;" align="left">Adı</td>
					<td width="100" style="background: red; color: black;" align="left">Fiyatı</td>
				</tr>
				<?php
				...
				if($FavoriSayisi>0){
					foreach($FavoriKayitlari as $FavoriSatirlar){
						...
						if($UrununUrunTuru == "Erkek T-Shirt"){
							$ResimKlasoruAdi	=	"Erkek";
						}elseif($UrununUrunTuru == "Kadın T-Shirt"){
