...
<body>
	<table width="1065" height="100%" align="center" border="0" cellpadding="0" cellspacing="0">
		<tr height="110">
			<td><table width="1065" height="50" align="center" border="0" cellpadding="0" cellspacing="0">
				<tr bgcolor="#0088CC">
					<td>&nbsp;</td>
					<?php
			...
			<table width="1065" height="80" align="center" border="0" cellpadding="0" cellspacing="0">
				<tr>
					...
					<td>
						<table width="760" height="20" align="center" border="0" cellpadding="0" cellspacing="0">
							<tr>
								<td width="200" class="AnaMenu" style="background: black"><a style="color: white" href="index.php">| Ana Sayfa |</a></td> 
								<td width="225" class="AnaMenu" style="background: black"><a style="color: white" href="index.php?SK=84">| Erkek T-Shirt |</a></td>
								<td width="225" class="AnaMenu" style="background: black"><a style="color: white" href="index.php?SK=85">| Kadın T-Shirt |</a></td>
								<td width="110" class="AnaMenu" style="background: black"><a style="color: white" href="index.php?SK=86">| Çocuk T-Shirt |</a></td>
							</tr>
						</table>
					</td>
				</tr>
