...
<table width="1065" align="center" border="0" cellpadding="0" cellspacing="0">
	...
	<tr>
		<td width="1065" valign="top">
			<table width="1065" align="center" border="0" cellpadding="0" cellspacing="0">
				<tr height="40">
					<td colspan="2" style="background:bisque"><h2 style="color:black">Hesabım > Yorumlar</h2></td>
				</tr>
				<tr height="30">
					<td colspan="2" valign="top" style="border-bottom: 1px dashed #CCCCCC;"><b>Tüm Yorumlarınız Bu Alandan Görüntüleyebilirsiniz.</b></td>
				</tr>
				<tr height="50">
					<td width="125" style="background: bisque; color: black;" align="left">&nbsp;Puan</td>
					<td width="75" style="background: bisque; color: black;" align="left">Yorum&nbsp;</td>
				</tr>
				<?php
				...
				?>
					<tr height="50">
						<td colspan="2" align="left"><b>Sisteme Kayıtlı Yorum Bulunmamaktadır.</b></td>
					</tr>
				<?php
				}
				?>
