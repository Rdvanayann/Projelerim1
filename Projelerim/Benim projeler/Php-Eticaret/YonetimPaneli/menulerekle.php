			...
			<td colspan="2"><table width="750" align="right" border="0" cellpadding="0" cellspacing="0">
				<tr height="40">
					...
					<td width="500"><select name="UrunTuru" class="SelectAlanlari">
						...
						<option value="Erkek Ayakkabısı">Erkek T-Shirt</option>
						<option value="Kadın Ayakkabısı">Kadın T-Shirt</option>
						<option value="Çocuk Ayakkabısı">Çocuk T-Shirt</option>
					</select></td>
				</tr>
				<tr height="40">
