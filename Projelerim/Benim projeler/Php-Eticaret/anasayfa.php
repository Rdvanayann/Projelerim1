<table width="1065" align="center" border="0" cellpadding="0" cellspacing="0">
	...
	<tr height="35">
		<td bgcolor="#E04747" style="color: #FFFFFF; font-weight: bold;">&nbsp;En Yeni Ürünler</td>
	</tr>
		...
		<td><table width="1065" align="center" border="0" cellpadding="0" cellspacing="0">
			<tr><?php
				...
				foreach($EnYeniUrunKayitlari as $EnYeniUrunSatirlari){
					...
					if($EnYeniUrununTuru=="Erkek T-Shirt"){
						$EnYeniUrunResimKlasoru		=	"Erkek";
					}elseif($EnYeniUrununTuru=="Kadın T-Shirt"){
						$EnYeniUrunResimKlasoru		=	"Kadin";
					}elseif($EnYeniUrununTuru=="Çocuk T-Shirt"){
	...
	<tr height="35">
		<td bgcolor="#E04747" style="color: #FFFFFF; font-weight: bold;">&nbsp;En Popüler Ürünler</td>
	</tr>
		...
		<td><table width="1065" align="center" border="0" cellpadding="0" cellspacing="0">
			<tr><?php
				...
				foreach($EnPopulerUrunKayitlari as $EnPopulerUrunSatirlari){
					...
					if($EnPopulerUrununTuru=="Erkek T-Shirt"){
						$EnPopulerUrunResimKlasoru		=	"Erkek";
					}elseif($EnPopulerUrununTuru=="Kadın T-Shirt"){
						$EnPopulerUrunResimKlasoru		=	"Kadin";
					}elseif($EnPopulerUrununTuru=="Çocuk T-Shirt"){
	...
	<tr height="35">
		<td bgcolor="#E04747" style="color: #FFFFFF; font-weight: bold;">&nbsp;En Çok Satan Ürünler</td>
	</tr>
		...
		<td><table width="1065" align="center" border="0" cellpadding="0" cellspacing="0">
			<tr><?php
				...
				foreach($EnCokSatanUrunKayitlari as $EnCokSatanUrunSatirlari){
					...
					if($EnCokSatanUrununTuru=="Erkek T-Shirt"){
						$EnCokSatanUrunResimKlasoru		=	"Erkek";
					}elseif($EnCokSatanUrununTuru=="Kadın T-Shirt"){
						$EnCokSatanUrunResimKlasoru		=	"Kadin";
					}elseif($EnCokSatanUrununTuru=="Çocuk T-Shirt"){
